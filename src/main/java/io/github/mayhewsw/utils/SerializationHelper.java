...
/*
 * SAME AS edu.illinois.cs.cogcomp.core.utilities.SerializationHelper EXCEPT this uses the FixedJsonSerializer class
 */
public class SerializationHelper {
    ...
    public static String serializeToJson(TextAnnotation ta, boolean writeTokenCharacterOffsets) {
        FixedJsonSerializer serializer = new FixedJsonSerializer();
