...
//fixed bug in edu.illinois.cs.cogcomp.core.utilities JsonSerializer, labelScoreMap now writes correctly
public class FixedJsonSerializer extends JsonSerializer

{
   ...
   // private static final Logger logger = LoggerFactory.getLogger(FixedJsonSerializer.class);
